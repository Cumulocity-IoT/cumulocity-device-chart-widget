...
@NgModule({
  declarations: [GpLibDeviceChartComponent, GpDeviceChartWidgetConfig],
  imports: [
    CoreModule,
    ChartsModule,
    MatButtonModule,
  ...
  exports: [GpLibDeviceChartComponent, GpDeviceChartWidgetConfig],
  entryComponents: [GpLibDeviceChartComponent, GpDeviceChartWidgetConfig],
  providers: [
